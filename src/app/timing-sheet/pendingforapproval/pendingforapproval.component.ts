...
@Component({
  ...
  styleUrls: ['./pendingforapproval.component.css']
})
  ...
  approvedTimehseet(){
    ...
    this.authService.timesheetApproval(this.addTimesheetList).subscribe(
      (res: any) => {
        ...
        swal.fire({ title: "Approved Timesheet Successfully!!", showConfirmButton: true })

      }, err => {
        swal.fire({ title: "Failed To Approved The Timesheet!!", showConfirmButton: true })
      })
  }
  ...
  rejectTimesheet(){
    ...
    this.authService.timesheetApproval(this.addTimesheetList).subscribe(
      (res: any) => {
        ...
        swal.fire({ title: "Failed To Reject The Timesheet!!", showConfirmButton: true })
      })
  }
