...
export class TechskillsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.editform = this.fb.group({
      'editskill': new FormControl(
        '', Validators.required,
      ),
    })

    this.userService.gettechSkillList().subscribe(
      res => {
        this.skillList = res;
        console.log("Resource Type  List for HR res", this.skillList);
      },
      err => {
  ...
  get editskill() {
    return this.editform.get('editskill')
  }
  ...
  addBusinessUnit() {
    ...
    postData = {
      ...
      "masterName": postData.skill,
      "masterType": "techskills"
    ...
    this.userService.addMasterRole(postData).subscribe(
      res => {
        ...
        console.log("API Success for addMasterRole skill", res);
        this.ngOnInit();
      },
      err => {
        console.log("API Failure for addMasterRole skill", err, err.error.text);
        this.ngOnInit();
      }
    );
  ...
  delete(hr_mas_id){
    ...
    $('#delete_skill_cofirm').modal('show');
  ...
  editSubmit(){
    ...
    processedData = {
      "emp_id": sessionStorage.getItem('emp_id'),
      "masterName": processedData.editskill,
      "masterType": "techskills",
      "masterId": this.master_id,
      "function" : "edit"
    }
  ...
  postdata(processedData){
    this.userService.editMasterRole(processedData).subscribe(
      res => {
        ...
        console.log("API Success for edit skill", res);
        this.ngOnInit();
      },
      err => {
        console.log("API Failure for edit skill", err, err.error.text);
        this.ngOnInit();
      }
    );
